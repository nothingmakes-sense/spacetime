...
pub const RECIPES: &[Recipe] = &[
    ...
    Recipe {
        ...
        name: "Cloth helm",
        station: CraftStation::Workbench,
        inputs: &[Ingredient { item: ItemId::TEXTILE, count: 2 }],
        output: Ingredient { item: ItemId::HELM, count: 1 },
        smelt_ticks: 0,
    },
    Recipe {
        id: 6,
        name: "Cloth tunic",
        station: CraftStation::Workbench,
        inputs: &[Ingredient { item: ItemId::TEXTILE, count: 3 }],
        output: Ingredient { item: ItemId::TUNIC, count: 1 },
        smelt_ticks: 0,
    },
    Recipe {
        id: 7,
        name: "Cloth gloves",
        station: CraftStation::Workbench,
        inputs: &[Ingredient { item: ItemId::TEXTILE, count: 1 }],
        output: Ingredient { item: ItemId::GLOVES, count: 1 },
        smelt_ticks: 0,
    },
    Recipe {
        id: 8,
        ...
        station: CraftStation::Workbench,
        inputs: &[
            Ingredient { item: ItemId::TEXTILE, count: 2 },
            Ingredient { item: ItemId::STICK, count: 1 },
        ],
        output: Ingredient { item: ItemId::BOOTS, count: 1 },
        smelt_ticks: 0,
    },
    Recipe {
        id: 9,
        ...
        station: CraftStation::Workbench,
        inputs: &[
            Ingredient { item: ItemId::IRON, count: 1 },
            Ingredient { item: ItemId::WOOD, count: 2 },
        ],
        output: Ingredient { item: ItemId::SHIELD, count: 1 },
        smelt_ticks: 0,
    },
    Recipe {
        id: 10,
    ...
    Recipe {
        ...
        name: "Cog x2",
        station: CraftStation::Workbench,
        inputs: &[Ingredient { item: ItemId::IRON, count: 1 }],
        output: Ingredient { item: ItemId::COG, count: 2 },
        smelt_ticks: 0,
    },
];
