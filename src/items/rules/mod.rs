...
pub const DEFAULT_LOOT: &[(u16, u16, f32, f32, f32)] = &[
    ...
    (ItemId::WOOD.0, 3, 1.6, 0.0, 1.3),
    (ItemId::STONE.0, 4, -1.4, 0.0, 1.4),
    (ItemId::ORE.0, 3, -3.2, 0.0, 2.2),
    (ItemId::COAL.0, 4, 3.4, 0.0, 2.0),
    (ItemId::RAW_MEAT.0, 2, 0.6, 0.0, 0.4),
    (ItemId::COPPER_NUGGET.0, 5, 2.8, 0.0, 0.6),
    (ItemId::SILVER_NUGGET.0, 3, -2.6, 0.0, 0.5),
    (ItemId::GOLD_NUGGET.0, 2, 0.0, 0.0, -1.2),
    (ItemId::COG.0, 4, 4.0, 0.0, 1.0),
    (ItemId::TEXTILE.0, 3, -4.0, 0.0, 1.2),
    (ItemId::FUEL_CAN.0, 1, 3.0, 0.0, 3.2),
];
